...
export default function VerifyPaymentPage() {
  ...
  const handleVerify = (e: React.FormEvent) => {
    ...
    // Redirecting to your dynamic receipt route
    router.push(`/verify/verify_receipt/${receiptId.trim()}`);
  };
    ...
    <div className="max-w-4xl mx-auto px-4 py-20 min-h-[80vh] flex flex-col items-center justify-center">
      ...
      <div className="text-center mb-12 space-y-4">
        <h1 className="text-4xl md:text-5xl font-black text-slate-900 font-montserrat tracking-tight">
          Verify with <span className="text-moss">Quirklr</span>
        </h1>
        <p className="text-slate-500 font-medium max-w-md mx-auto">
          Enter a unique Receipt ID to verify its cryptographic anchor and ISO
          20022 data on the Flare Network.
        </p>
      </div>
      ...
      >
        ...
        <input
          ...
          placeholder="Enter Receipt ID (e.g. RCPT-XXXX...)"
        ...
        <button
          type="submit"
          disabled={isRedirecting || !receiptId}
