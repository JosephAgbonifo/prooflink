...
export const createProject = async (req, res) => {
  ...
  try {
    ...
    if (!title || !description || !creatorWallet || !paymentType || !currency) {
    ...
    if (currency === "FXRP") {
      addr = "0x8b4aba9c4bd7dd961659b02129bee20c6286e17f";
    } else if (currency === "USDT0") {
      addr = "0xc1a5b41512496b80903d1f32d6dea3a73212e71f";
    } else {
    ...
    try {
      const tx = await vaultContract.registerProject(projectId, addr);
