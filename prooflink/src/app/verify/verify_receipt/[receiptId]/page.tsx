  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 md:py-12">
      ...
      <div className="flex flex-wrap justify-between items-center mb-6 gap-4 print:hidden">
        ...
        <button
          onClick={handlePrint}
          className="flex items-center gap-2 bg-deep text-white px-4 py-2 rounded-lg hover:bg-opacity-90 transition text-sm font-semibold"
        >
        ...
        <div className="bg-slate-900 p-6 md:p-8 text-white">
          <div className="flex flex-col md:flex-row justify-between items-start gap-4">
            <div>
              ...
              <p className="text-white/50 font-mono text-xs md:text-sm mt-1 break-all">
                {receiptId}
              </p>
            </div>
